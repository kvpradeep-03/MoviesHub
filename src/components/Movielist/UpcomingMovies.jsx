...
const UpcommingMovies = () => {
    ...
    const fetchMovies = async () => {
        const response = await fetch("https://api.themoviedb.org/3/movie/upcoming?api_key=f5f93f9ee89c6f6e2d5892ecf2987379")
        ...
        <>
            <Box className="movie-list-header">
                <Typography variant='h4' color='text.primary' className="movie-list-heading">
                    Upcoming <UpcomingIcon sx={{ ml: 2, alignItems: 'center', fontSize: 'inherit' }} />
                </Typography>
                {/* 
